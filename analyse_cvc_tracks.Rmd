...
cur_dat_to_plot <- cur_dat_to_plot[cur_dat_to_plot$ERROR_CODE == 0,]
...
plot_track_class('TRACK_CLASS_SEG', class_seg_levels, 300)
...
plot_track_class('TRACK_CLASS_CVC', class_cvc_levels, 200)
...
plot_track_class('TRACK_CLASS_ACQ', class_acq_levels, 15)
```
